...
export function TaskDetailDialog({ task, open, onOpenChange }: TaskDetailDialogProps) {
  ...
  const dateDisplay = format(task.startDate, "d 'de' MMMM, yyyy", { locale: es }) === format(task.endDate, "d 'de' MMMM, yyyy", { locale: es })
    ? format(task.startDate, "d 'de' MMMM, yyyy", { locale: es })
    : `${format(task.startDate, "d 'de' MMMM, yyyy", { locale: es })} - ${format(task.endDate, "d 'de' MMMM, yyyy", { locale: es })}`
